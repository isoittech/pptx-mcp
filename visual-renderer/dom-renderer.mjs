...
function renderBullets(slide) {
  ...
  const body = `<div class="bullet-list${split ? " split" : ""}">${items.map((item) => `<ul class="bullet-row"><li>${escapeHtml(item)}</li></ul>`).join("")}</div>`;
